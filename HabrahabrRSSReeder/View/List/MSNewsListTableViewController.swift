...
final class MSNewsListTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if self.navigationController?.topViewController?.isKind(of: MSNewsDetailTableViewController.self) == false,
            let detailVC = MSNewsDetailTableViewController.storyboardInstance {
